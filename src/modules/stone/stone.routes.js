...
router.get(
  "/options",
  canRead,
  validateRequest(stoneAdminListSchema),
  stoneController.options,
);
router.get(
  "/",
  canRead,
  validateRequest(stoneAdminListSchema),
  stoneController.list,
);

router.post(
  "/",
  canManage,
  validateRequest(stoneCreateSchema),
...
router.get(
  "/:id",
  canRead,
  validateRequest(stoneGetSchema),
  stoneController.get,
);
router.patch(
  "/:id",
  canManage,
  validateRequest(stoneUpdateSchema),
...
router.delete(
  "/:id",
  adminOnly,
  validateRequest(stoneDeleteSchema),
